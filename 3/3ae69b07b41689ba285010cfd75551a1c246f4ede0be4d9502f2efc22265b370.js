...
String.prototype.trim=function(){};if(typeof(String.prototype.left)!=="function")
...
String.prototype.contains=function(){};if(typeof(String.prototype.startsWith)!=="function")
...
{return doc.getElementById(id);},_getByTagName:function(){},_getFirstByTagName:function(){},_getFirstByClassName:function(pClassName,pTag,pContainer)
...
{return(p!=null);},_isUndefinedOrNull:function(){},_isString:function(p)
...
{return(this._is(p)&&this._typeOf(p)=="array");},_isNotEmptyArray:function(){},_isNotEmptyString:function(){},_isFun:function(){},_error:function(pMessage)
{debugger;console.error('ratingwidget: '+pMessage);throw('ratingwidget: '+pMessage);},_guid:function(){},_getStyle:function(pElement,pProperty)
...
{return WWW_JS+path.ltrim('/');},_cssUrl:function(){},_setAttr:function(e,a,v)
{if(this._isString(a))
{e.setAttribute(a,v);}
else
{for(var p in a)
...
{return e.getBoundingClientRect().height;},docOffset:function(){},browserWidth:function()
...
RW.hide(e);else
e.style.display='';},remove:function(){},isVisible:function(e)
...
{var matches=(url||window.location.toString()).match(_DOMAIN_REGEX);return matches&&matches[1];},attachEvent:function(){},_setRecommendations:function(data)
...
return;f.apply(element,[event]);});},_renderPoweredBy:function(){},executeWhen:function(predicate,callback,iteration)
{if(predicate())
...
{return((RW.IDENTIFICATION.ACCOUNT===RW.visitor.identifyBy)&&!RW.isConnected());},connectUrl:function(){},isLocalhost:function()
...
{var s=doc.createElement("link");s.type="text/css";s.rel="stylesheet";s.href=url;s.media="screen";return s;},_fingerprint='',_callbacks={},_getCallbackName=function(){};if(RW._isNotEmptyString(window.navigator.platform))
...
q+=((i>0)?"&":"")+data[i].name+"="+data[i].value;return q;},toNameValue:function(){},fromNameValue:function(arr)
...
{if(!this.test())
return false;var cookies=_parseCookies();return(cookies[key]!==undef);}};};var hasStorage=(function(){}());if(undef!==hasStorage)
...
{localStorage.removeItem(key);},contains:function(){}};}();}
else
...
{return _isLoaded()?((false!==_dataCache&&RW._isArray(_dataCache.recs))?_dataCache.recs.length:0):0;};$.set=function(){};$.append=function(data)
...
{return'M'+point.x+','+point.y;},line:function(){},arc:function(r,point,isLargeArc,isClockwise,xAxisRotation)
...
{return _refreshUI;};$.refresh=function(){};$.getOption=function(option,i)
{if(undef===i)
...
{_options=RW._extandObj(_getOptions(element),o);return _options;},_getLoaderHtml=function(){},_renderLoading=function()
...
return RW._extandObj(d,_getClassOptionsLegacy(e));},_getOptions=function(){},_normalizeOptions=function()
...
{if($.isThumb())
return rate;var n=rate*(_a.star.stars/RW.MAX);return(true===round)?Math.round(n):n;};$.isReady=function(){};$.isActive=function()
...
res=true;else
res=(true===_isTimePassed(_r.lastVote.created,_o.frequency));RW._Class.toggle(_e,PREFIX+"active",(true===res));return res;};$.isActiveAndReady=function(){};$.setOptions=function(o)
...
{return(RW._isArray(_r.recommendations)&&_r.recommendations.length>0);};$.recommendationsCount=function(){};$.getRecommendations=function()
...
html+=_renderPoweredBy();return html.isEmpty()?'':'<div class="rw-ui-poweredby">'+html+'</div>';},_renderSharing=function(){},_renderStarReport=function()
...
{return((hex.length>4)?hex:'#'+hex[1]+hex[1]+hex[2]+hex[2]+hex[3]+hex[3]).toUpperCase();},_rgb2Hex=function(){}